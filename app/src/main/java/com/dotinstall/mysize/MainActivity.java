...
public class MainActivity extends AppCompatActivity {
    ...
    public void onSaveTapped(View view) {
        ...
        editor.putString(SLEEVE, editNeck.getText().toString());
        editor.putString(WAIST, editNeck.getText().toString());
        editor.putString(INSEAM, editNeck.getText().toString());
        editor.commit();
    }
}
